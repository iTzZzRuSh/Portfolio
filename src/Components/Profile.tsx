...
function Profile() {
  ...
  return (
        <Flex direction={isNotSmallerScreen ? "row" : "column"} w="100%" maxWidth={{ base: "100vh", md: "130vh", lg: "130vh", xl: "130vh" }}>
          ...
          <Box alignSelf="center" px="32" py="16">
            <Text fontWeight="bold" fontSize="2xl">Something about something important but not</Text>
              <Flex direction={isNotSmallerScreen ? "row" : "column"} mt={4}>
                  ...
                  <Flex rounded="xl" direction="column" ml={4} mt={isNotSmallerScreen ? 4 : 0} bg="gray.100" h="30vh" w="30vh" justify="flex-end" _hover={{bg: "teal.400", }}>
                    <Icon color="black" p="4" as={DiCodeigniter} w="24" h="24"/> 
                    <Text color="black" p="4" fontSize="xl" fontWeight="semibold">
                        Flutter Apps
                    </Text>
                  </Flex>
                  <Flex rounded="xl" direction="column" ml={4} mt={isNotSmallerScreen ? 4 : 0} bg="gray.100" h="30vh" w="30vh" justify="flex-end" _hover={{bg: "green.400", }}>
